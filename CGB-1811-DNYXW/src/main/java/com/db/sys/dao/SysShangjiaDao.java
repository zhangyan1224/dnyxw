 ...
 */
public interface SysShangjiaDao {
	/**
	 * 基于条件分页查询日志信息
	 ...
	 */
	List<SysShangpin> findPageObjects(@Param("shangjia_name")String shangjia_name,
									  @Param("startIndex")Integer startIndex,
									  @Param("pageSize")Integer pageSize
								);
	List<SysShangpin> findPageObject(@Param("youxi_name")String youxi_name,
									 @Param("shangjia_name")String shangjia_name,
									 @Param("startIndex")Integer startIndex,
									 @Param("pageSize")Integer pageSize
			);
	/**
	 ...
	 */
	int getRowCount(@Param("shangjia_name")String shangjia_name);
	int getRowCount1(@Param("youxi_name")String youxi_name,@Param("shangjia_name")String shangjia_name);
	/**
	 * 基于条件删除指定记录
	 * @param ids 特殊的数组
	 * @return
