...
public class SysShangjiaController {
	...
	public JsonResult doFindPageObjects(Integer pageCurrent) {
		PageObject<SysShangpin> PageObject = sysShangjiaService.findPageObjects(pageCurrent);
	...
	public JsonResult doFindPageObject(String shangjia_name,Integer pageCurrent) {
		PageObject<SysShangpin> PageObject = sysShangjiaService.findPageObject(shangjia_name, pageCurrent);
