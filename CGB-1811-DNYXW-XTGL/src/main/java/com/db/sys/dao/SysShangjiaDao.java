...
public interface SysShangjiaDao {
	 ...
	 */
	List<SysShangpin> findPageObjects(@Param("startIndex")Integer startIndex,
								@Param("pageSize")Integer pageSize
								);
	List<SysShangpin> findPageObject(@Param("shangjia_name")String shangjia_name,
	 ...
	 */
	int getRowCount();
	int getRowCount1(@Param("shangjia_name")String shangjia_name);
	/**
	 * 基于条件删除指定记录
	 * @param ids 特殊的数组
	 * @return
